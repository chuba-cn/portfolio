...
const AboutContent = () => {
  return (
    <div className="grid w-full grid-cols-8 gap-16">
      ...
      <div className="col-span-3 relative h-full border-2 border-dark border-solid bg-light p-8 flex items-center justify-center rounded-2xl">
        <div className={"flex items-center justify-center bg-dark rounded-2xl h-[90%]"}>
